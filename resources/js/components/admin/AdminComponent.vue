      ...
      <nav>
        <div class="nav-wrapper">
          <ul id="nav-mobile" class="center">
            <li>
              <a class="active" @click="setComponent('main')">Dashboard</a>
            </li>
            ...
            <li><a @click="setComponent('tour')">Tour</a></li>
            <li title="Register an admin">
              <a @click="setComponent('register')">Register</a>
            </li>
          </ul>
        </div>
      </nav>
...
export default {
  ...
  beforeMount() {
    ...
    Axios.defaults.headers.common["Authorization"] =
      "Bearer " + localStorage.getItem("manKind.jwt");
  },
  methods: {
    setComponent(value) {
      switch (value) {
        ...
        case "audio":
          ...
          break;
        case "tour":
          this.activeComponent = Tour;
          this.$router.push({ name: "admin-pages", params: { page: "tour" } });
          break;
        case "register":
